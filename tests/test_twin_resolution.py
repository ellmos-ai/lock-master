...
# Die Implementierung liegt im Klon unter pure-locking/, in der deployten
# Fassung dagegen neben dem Test. Beide Lagen werden unterstuetzt, damit
# derselbe Test an beiden Orten laeuft (Reissverschluss-Merge T-20260913-715231627).
